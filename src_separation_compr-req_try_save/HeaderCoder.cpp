...
void AbstractHeaderCoder::endHeader(){
	cerr << "AbstractHeaderCoder::endHeader - start" << endl;
	...
	for(int i=0; i<_prevFieldCount+1; i++){
		cerr << "AbstractHeaderCoder::endHeader - before _prevFieldPos[i] = _currentFieldPos[i] " << endl;
		_prevFieldPos[i] = _currentFieldPos[i];
		cerr << "AbstractHeaderCoder::endHeader - _prevFieldPos[i] : " << _prevFieldPos[i] << endl;
	...
	cerr << "AbstractHeaderCoder::startBlock - after for loop " << endl;
...
void AbstractHeaderCoder::startBlock(){
	...
	cerr << "AbstractHeaderCoder::startBlock - start" << endl;

	_currentHeader = _leon->_firstHeader;
	cerr << "AbstractHeaderCoder::startBlock - _currentHeader : " << _currentHeader << endl;
	...
	cerr << "AbstractHeaderCoder::startBlock - before _headerSizeModel.clear()" << endl;
	_headerSizeModel.clear();
	cerr << "AbstractHeaderCoder::startBlock - after _headerSizeModel.clear()" << endl;
	
	cerr << "AbstractHeaderCoder::startBlock - before splitHeader()" << endl;
	splitHeader();
	cerr << "AbstractHeaderCoder::startBlock - after splitHeader()" << endl;
	cerr << "AbstractHeaderCoder::startBlock - before endHeader()" << endl;
	endHeader();
	cerr << "AbstractHeaderCoder::startBlock - after endHeader()" << endl;
...
void HeaderDecoder::setup(u_int64_t blockStartPos, u_int64_t blockSize, int sequenceCount){
	...
	cerr << "HeaderDecoder::setup - before startBlock() : " << endl;
	startBlock();
	cerr << "HeaderDecoder::setup - after startBlock() : " << endl;
	cerr << "HeaderDecoder::setup - before _rangeDecoder.clear() :  " << endl;
	_rangeDecoder.clear();
	cerr << "HeaderDecoder::setup - after _rangeDecoder.clear() : " << endl;
...
void HeaderDecoder::endHeader(){
	cerr << "HeaderDecoder::endHeader - before _buffer += _currentHeader + '\n';" << endl;
	_buffer += _currentHeader + '\n';
	cerr << "HeaderDecoder::endHeader - after _buffer += _currentHeader + '\n';" << endl;
	cerr << "HeaderDecoder::endHeader - _buffer : " << _buffer << endl;
	...
	cerr << "HeaderDecoder::endHeader - before splitHeader()" << endl;
	splitHeader();
	cerr << "HeaderDecoder::endHeader - after splitHeader()" << endl;
